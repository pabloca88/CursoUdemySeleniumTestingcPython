...
def pytest_addoption(parser):
    ...
    parser.getgroup("general").addoption('--allure-link-pattern',
                                         ...
                                         default=[],
                                         type=link_pattern,
                                         help="""Url pattern for link type. Allows short links in tests,
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "{mark}: allure tests name marker".format(mark=ALLURE_DISPLAY_NAME_MARK))
